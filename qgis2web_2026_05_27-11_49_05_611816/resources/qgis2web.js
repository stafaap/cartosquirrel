...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         maxZoom: 20, minZoom: 8, projection: new ol.proj.Projection({
            code: 'EPSG:3067',
            //extent: [265642.541500, 6632288.090200, 475008.681000, 6746389.445000],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([253828.763724, 6604141.906611, 504378.131799, 6773432.020175], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Flying squirrel observations</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (298 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Flying squirrel observations in the Uusimaa region. Click an observation to view the details. Every municipality contains a histogram of the observations trough the years (in finnish). <br />There is a municipality search that highlights the searched municipaltiy from Uusimaa, works with finnish names.';
            }
